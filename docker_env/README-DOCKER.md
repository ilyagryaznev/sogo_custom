...
Файлы из этой папки (docker_env) не являются частью пакета sogo, эту папку нужно вытащить уровнем выше, а в нее положить сам клиент sogo в папку sogo_custom. Также нужна папка с исходниками sope. Ну или переписать пути). 
